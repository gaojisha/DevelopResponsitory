package com.gjs.developresponsity.video.controller;
...
public class SdcardImageController {
    ...
    public static class SdcardControllerBuilder {
        ...
        public SdcardControllerBuilder(@NonNull String path) {
            sdcardParams = new SdcardImageController();
        ...
        public SdcardControllerBuilder setPlaceDrawable(int placeId) {
            sdcardParams.placeDrawable = mContext.getResources().getDrawable(placeId);
            return this;
        }
        ...
        public SdcardControllerBuilder setFailDrawable(int failId) {
            sdcardParams.failDrawable = mContext.getResources().getDrawable(failId);
            return this;
        }
